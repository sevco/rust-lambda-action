...
![GitHub](https://img.shields.io/github/license/sevco/rust-lambda-action@1.56.0)
![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/sevco/rust-lambda-action@1.56.0)
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/sevco/rust-lambda-action@1.56.0/CI)
...
```yaml
- uses: sevco/rust-lambda-action@1.56.0v1.0.2
  with:
